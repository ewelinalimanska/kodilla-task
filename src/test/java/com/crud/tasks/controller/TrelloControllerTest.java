...
@RunWith(SpringRunner.class) //uruchomienie kontekstu Springa; możliwość wykorzystania np. @Autowired
@WebMvcTest(TrelloController.class) //automatyczne konfigurowanie infrastruktury MVC
public class TrelloControllerTest {
    ...
    @Test //ma zwrócić pustą listę tablic
    public void shouldFetchEmptyTrelloBoards() throws Exception {

        //Given - deklarujemy zwracanie pustej listy przez metodę fetchTrelloBoards
    ...
    @Test // powinien zwrócić listę zawierającą obiekty
